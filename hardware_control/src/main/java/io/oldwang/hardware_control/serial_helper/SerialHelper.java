...
public class SerialHelper {
    ...
    private DataReceivedCall mDataReceived;
    ...
    public void setDataReceivedCall(DataReceivedCall dataReceived) {
//        if (null != dataReceived) {
        this.mDataReceived = dataReceived;
//        }
    }

    public DataReceivedCall getDataReceived() {
    ...
    public void sendHex(String sHex) {
        byte[] bOutArray = RubFunc.HexToByteArr(sHex);
        send(bOutArray);
    }
...
//                        LOGGER.error("读取数据为空");
    ...
    public void setHexLoopData(String sHex) {
        this._bLoopData = RubFunc.HexToByteArr(sHex);
    }
