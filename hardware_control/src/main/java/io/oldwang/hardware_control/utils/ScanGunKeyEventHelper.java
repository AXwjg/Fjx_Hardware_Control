...
public class ScanGunKeyEventHelper {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ScanGunKeyEventHelper.class);
    ...
    private String mDeviceName = "Newland Auto-ID BUS";
...
//    }
    ...
    public boolean isScanGunEvent(KeyEvent event) {
        LOGGER.info("设备名称: {}", event.getDevice().getName() + "  -------");
